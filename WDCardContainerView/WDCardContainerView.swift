...
extension WDCardContainerView {
            ...
            if currentIndex != numberOfCards {
                ...
                if currentIndex == numberOfCards {
                    ...
                    for index in 0...(numberOfCards-1) {
                        windowView.addSubview(cards[index]!)
                    }
                    cycleDown()
                }
            } else {
    ...
    private func setupCardFrames() {
        ...
        middleCardCenter = CGPointMake(windowView.center.x - 5, windowView.center.y + 10)
        bottomCardCenter = CGPointMake(windowView.center.x + 5, windowView.center.y + 20)
